...
namespace IdentitySample.Controllers
{
    ...
    public class ManageController : BaseController
    {
        ...
        public string UserName
        {
            get
            {
                return _userName ?? User.Identity.GetUserId();
            }
            set
            {
                _userName = value;
        ...
        public async Task<ActionResult> Index(ManageMessageId? message)
        {
            ...
            model.Logins = new List<UserLoginInfo>();
            model.PhoneNumber = await UserRepository.GetPhoneNumberAsync(UserName, UserManager);
            model.TwoFactor=await UserRepository.GetTwoFactorEnabledAsync(UserName, UserManager);

            model.Logins = await UserRepository.GetLoginsAsync(UserName, UserManager);
            model.BrowserRemembered=await UserRepository.TwoFactorBrowserRememberedAsync(UserName, AuthenticationManager);
        ...
        {
            var user = UserRepository.FindId(UserName, UserManager);
            if (user != null)
            {
